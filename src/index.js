 ...
 * @returns {string}
 */
export function ipFromLong(ipInt) {
 ...
 * @param {string} ip2 
 */
export function getTotalIPs(ip1, ip2) {
 ...
 */
export function isRange(ipRange) {
 ...
 */
export function isCidr(ipRange) {
    if (ipRange.indexOf('/') == -1) return false;
 ...
 */
export function convertCidrToRange(cidr) {
 ...
 */
export function getIpFromRangeByIndex(start_ip, end_ip, index) {
 ...
 */
export function isIpInRange(ip, start_ip, end_ip) {
    let start_ip_long = ipToLong(start_ip);
    let end_ip_long = ipToLong(end_ip);
 ...
 */
export function getSubRange(start_ip, end_ip, chunk_size = 1000) {
    let start_ip_long = ipToLong(start_ip);
    let end_ip_long = ipToLong(end_ip);
 ...
 */
export function generateArrayOfIp(start_ip, end_ip, chunk_size = 1000) {
    let array = [];
    let start_ip_long = ipToLong(start_ip);
    let end_ip_long = ipToLong(end_ip);
